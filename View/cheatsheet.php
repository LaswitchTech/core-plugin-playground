            ...
            <div class="container-fluid d-flex align-items-center">
                <h1 class="d-flex align-items-center fs-4 text-white mb-0">
                    <a href="/" class="d-flex align-items-center text-white text-decoration-none">
                        <img src="/img/logo.png" width="30" height="30" class="me-3" alt="Bootstrap">
                    </a>
                    <a href="/playground" class="d-flex align-items-center text-white text-decoration-none">Playground</a>
                </h1>
            </div>
        </header>
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="my-2">
                        ...
                        <ul class="list-unstyled ps-3 collapse" id="components-collapse">
                            ...
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#calendar">Calendar</a></li>
                            ...
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#feed">Feed</a></li>
                            ...
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#ribbon">Ribbon</a></li>
                            ...
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#timeline">Timeline</a></li>
                    ...
                    <!-- Utilities -->
                    <li class="my-2">
                        <button type="button" class="btn d-inline-flex align-items-center collapsed border-0" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#utilities-collapse" aria-controls="utilities-collapse">Utilities</button>
                        <ul class="list-unstyled ps-3 collapse" id="utilities-collapse">
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#animations">Animations</a></li>
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#background">Background</a></li>
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#cursors">Cursors</a></li>
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#emphasis">Emphasis</a></li>
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#opacity">Opacity</a></li>
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#position">Position</a></li>
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#sizing">Sizing</a></li>
                            <li><a class="d-inline-flex align-items-center rounded text-decoration-none" href="#spacing">Spacing</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
        </aside>
        <main class="bd-cheatsheet container-fluid bg-body pb-5">
            <section id="content">
            ...
            <section id="components">
                ...
                <article class="my-3" id="calendar">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Calendar</h3>
                    </div>
                    <div>
                                ...
                                <nav class="navbar navbar-expand-lg bg-body-tertiary">
                                    <div class="container-fluid">
                                        <a class="navbar-brand" href="#">
                                            <img src="/img/logo.png" width="38" height="30" class="d-inline-block align-top" alt="Bootstrap" loading="lazy" style="filter: invert(1) grayscale(100%) brightness(200%);">
                                        </a>
                ...
                <article class="my-3" id="timeline">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Timeline</h3>
                    </div>
                    <div>
            ...
            <section id="utilities">
                <h2 class="sticky-xl-top fw-bold pt-3 pt-xl-5 pb-2 pb-xl-3">Utilities</h2>
                <article class="my-3" id="animations">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Animations</h3>
                    </div>
                    <div class="bd-example-snippet bd-code-snippet">
                ...
                <article class="my-3" id="background">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Background</h3>
                    </div>
                    <div>
                ...
                <article class="my-3" id="emphasis">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Emphasis</h3>
                    </div>
                    <div>
                ...
                <article class="my-3" id="position">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Position</h3>
                    </div>
                    <div>
                        ...
                        <div class="bd-example-snippet bd-code-snippet">
                            <div class="bd-example m-0 border-0">
                                <div class="card card-body d-block" style="height: 200px;">
                                    <div class="h-25 text-bg-primary d-inline-block" style="width: 19%;">Height 25%</div>
                                    <div class="h-50 text-bg-primary d-inline-block" style="width: 19%;">Height 50%</div>
                                    <div class="h-75 text-bg-primary d-inline-block" style="width: 19%;">Height 75%</div>
                                    <div class="h-100 text-bg-primary d-inline-block" style="width: 19%;">Height 100%</div>
                                    <div class="h-auto text-bg-primary d-inline-block" style="width: 19%;">Height auto</div>
                                </div>
                            </div>
                        </div>
                    </div>
                </article>
                <article class="mt-3 mb-5 pb-5" id="spacing">
                    <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                        <h3>Spacing</h3>
                    </div>
                    <div>
