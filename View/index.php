...
<header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
    <div class="container-fluid d-flex align-items-center">
        <h1 class="d-flex align-items-center fs-4 text-white mb-0">
            <img src="/img/logo.png" width="38" height="30" class="me-3" alt="Logo">
            Cheatsheet
        </h1>
    </div>
</header>
...
<main class="bd-cheatsheet container-fluid bg-body">
    ...
    <section id="forms">
        ...
        <article class="my-3" id="sizing">
            <div class="bd-heading sticky-xl-top align-self-start mt-5 mb-3 mt-xl-0 mb-xl-2">
                <h3>Sizing</h3>
                <a class="d-flex align-items-center" href="/docs/5.3/forms/form-control/#sizing">Documentation</a>
            </div>
            <div>
                <div class="bd-example-snippet bd-code-snippet">
                    <div class="bd-example m-0 border-0">
                ...
                <div class="bd-example-snippet bd-code-snippet">
                    <div class="bd-example m-0 border-0">
                        <nav class="navbar navbar-expand-lg bg-body-tertiary">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="#">
                                    <img src="/img/logo.png" width="38" height="30" class="d-inline-block align-top" alt="Logo" loading="lazy" style="filter: invert(1) grayscale(100%) brightness(200%);">
                                </a>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-dark bg-primary mt-5">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="#">
                                    <img src="/img/logo.png" width="38" height="30" class="d-inline-block align-top" alt="Logo" loading="lazy">
                                </a>
